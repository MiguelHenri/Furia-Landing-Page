...
VALUES (
    'GUERRI EM COLOGNE?',
    'Agora head de esports da FURIA, Nicholas "guerri" Nogueira acompanhou a equipe de CS2 na IEM Cologne, o que chamou a atenção do público já que ele não é mais o coach. Neste domingo, o também sócio da organização explicou o por que esteve junto com o time na "Catedral" do Counter-Strike.',
    'https://www.dust2.com.br/noticias/51885/guerri-explica-por-que-acompanhou-furia-em-cologne',
    'guerrifuria.jpg'
);
...
VALUES (
    ...
    'R$179,99',
    'https://furia.gg/product/camiseta-champion-x-furia-mascot-hoodie-preta/?attribute_tamanho=G&gad_source=1&gclid=CjwKCAjw_ZC2BhAQEiwAXSgClssbsVKj29ZedrZZ8ldao9_f5lnGSYdkUwikapdYm7NkE3Cfpbq_vxoCgSsQAvD_BwE',
    'store1furia.webp'
);
